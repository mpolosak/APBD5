...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(h => h.Sal).Reverse().Take(2).ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = from emp in emps
                    let Total = emp.Sal + emp.Comm.GetValueOrDefault(0)
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from emp in emps
            ...
            from s in grades
            where emp.Sal >= s.Losal && emp.Sal <= s.Hisal
            select new { emp.EName, dept.DName, s.Grade };
